...
| **Solution**                                                                                                                                                                                      | **Pros**                                                                                                                                    | **Cons**                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![](pts645_switch.png)<br>\* Option 1.<br>\* PTS645 Tactile Switch <br>\* $0.28/each<br>\* [link to product](https://www.mouser.com/ProductDetail/CK/PTS645SL50-2-LFS?qs=rqnA19JZHeTZYaJU%252B5olWA%3D%3D)                 | \* Inexpensive<br>\* Long life expectancy<br>\* Taller button                                               | \* Slow shipping speed |
