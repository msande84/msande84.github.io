...
| **Solution**                                                                                                                                                                                      | **Pros**                                                                                                                                    | **Cons**                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![](pts645_switch.png)<br>\* Option 1.<br>\* The PTS645 switch series are 6mm tactile switches <br>\* $0.28/each<br>\* [link to product](https://www.mouser.com/ProductDetail/CK/PTS645SL50-2-LFS?qs=rqnA19JZHeTZYaJU%252B5olWA%3D%3D)                 | \* Inexpensive<br>\* Long life expectancy<br>\* Low power requirement                                               | \* Slow shipping speed<br>\* Needs special PCB layout. |
